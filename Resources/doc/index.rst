...
.. code-block:: php
         ...
         public function registerBundles()
         {
            $bundles = array(
                // ...
                new Aldaflux\NotificationBundle\AldafluxNotificationBundle(),
                // ...
            );
         }
...
2. Implement the ``Aldaflux\NotificationBundle\NotifiableInterface`` interface (it's an empty interface)
...
.. code-block:: php
    ...
    ...
    use Aldaflux\NotificationBundle\Annotation\Notifiable;
...
.. code-block:: yaml
    ...
    mgilet_notification:
        resource: "@AldafluxNotificationBundle/Controller/"
