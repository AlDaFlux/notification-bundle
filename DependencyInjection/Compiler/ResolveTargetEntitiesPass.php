...
namespace Aldaflux\NotificationBundle\DependencyInjection\Compiler;
...
class ResolveTargetEntitiesPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $notificationEntityClass = $container->getParameter('aldaflux_notification.notification_class');
