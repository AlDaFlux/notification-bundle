...
namespace Aldaflux\NotificationBundle\Twig;
...
class NotificationExtension extends AbstractExtension
{
    ...
    {
        return array(
            new TwigFunction('aldaflux_notification_render', [$this, 'render'], ['is_safe' => ['html']]),
            new TwigFunction('aldaflux_notification_count', [$this, 'countNotifications'], ['is_safe' => ['html']]),
            new TwigFunction('aldaflux_notification_unseen_count', [$this, 'countUnseenNotifications'], ['is_safe' => ['html']]),
            new TwigFunction('aldaflux_notification_generate_path', [$this, 'generatePath'], ['is_safe' => ['html']])
        );
    }
    ...
    public function renderNotifications(NotifiableInterface $notifiable, array $options)
    {
        ...
        $template = array_key_exists('template', $options) ? $options['template'] : '@AldafluxNotification/notification_list.html.twig';
