 ...
 *
 * @ORM\Entity(repositoryClass="Aldaflux\NotificationBundle\Entity\Repository\NotifiableRepository")
...
class NotifiableEntity implements \JsonSerializable
{
     ...
     * @ORM\OneToMany(targetEntity="Aldaflux\NotificationBundle\Entity\NotifiableNotification", mappedBy="notifiableEntity",cascade={"persist"})
     */
