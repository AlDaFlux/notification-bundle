 ...
 *
 * @ORM\Entity(repositoryClass="Aldaflux\NotificationBundle\Entity\Repository\NotifiableNotificationRepository")
 *
 */
class NotifiableNotification implements \JsonSerializable
{
    ...
    /**
     * @var Notification
     * @ORM\ManyToOne(targetEntity="Aldaflux\NotificationBundle\Entity\Notification", inversedBy="notifiableNotifications", cascade={"persist"})
     */
    protected $notification;

    /**
     * @var NotifiableEntity
     * @ORM\ManyToOne(targetEntity="Aldaflux\NotificationBundle\Entity\NotifiableEntity", inversedBy="notifiableNotifications", cascade={"persist"})
     *
     */
