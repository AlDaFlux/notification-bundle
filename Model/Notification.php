...
namespace Aldaflux\NotificationBundle\Model;
 ...
 *
 * @ORM\MappedSuperclass(repositoryClass="Aldaflux\NotificationBundle\Entity\Repository\NotificationRepository")
 * @package Aldaflux\NotificationBundle\Model
 */
abstract class Notification implements \JsonSerializable
{
     ...
     * @ORM\OneToMany(targetEntity="Aldaflux\NotificationBundle\Entity\NotifiableNotification", mappedBy="notification", cascade={"persist"})
     */
